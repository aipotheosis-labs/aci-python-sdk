...
SCHEMA: BaseFunctionSchema = {
    ...
    "function": {
        "name": NAME,
        "description": "This function allows you to find relevant executable functions (tools) that can help complete your tasks or get data and information you need.",
        "parameters": {
            "type": "object",
            "properties": {
                "intent": {
                    "type": "string",
                    "description": "Use this to discover relevant functions (tools) you might need. Returned results of this function will be sorted by relevance to the intent. Examples include 'what's the top news in the stock market today', 'i want to automate outbound marketing emails'.",
                },
                "limit": {
                    "type": "integer",
                    "default": 100,
