...
AIPOLABS_ACI_API_KEY = os.getenv("AIPOLABS_ACI_API_KEY")
...
@pytest.mark.skipif(AIPOLABS_ACI_API_KEY is None, reason="AIPOLABS_ACI_API_KEY is not set")
def test_app_configurations() -> None:
    aci = ACI(api_key=AIPOLABS_ACI_API_KEY)
    ...
    assert app_configurations[0].app_name in ["GMAIL", "BRAVE_SEARCH", "AIPOLABS_SECRETS_MANAGER"]
